...
return [
    ...
    */
    ...
    | la convención "attribute.rule" para nombrar las líneas. Esto hace que sea rápido
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para intercambiar los marcadores de posición
    | de atributos con algo más amigable para el lector, como "Dirección de correo electrónico"
    | en lugar de "email". Esto simplemente nos ayuda a hacer que los mensajes sean más claros.
    |
    */
